...
const PLAN_RENEW_REMIND = ({ partner = 'mimedia', language = 'en' }: EmailProps) => {
    return (
        <Template language={language} partner={partner}>
            <Heading className='text-[24px] font-normal text-center p-0 my-[30px] mx-0'>
                <Trans
                    i18n={getInstanceFromLanguage(language)}
                    i18nKey={'planRenewRemind.planRenew'}
                />
            </Heading>
            <Text className='mb-2'>
            ...
            <Text className='mb-2'>
                <Trans
                    i18n={getInstanceFromLanguage(language)}
                    i18nKey={'planRenewRemind.remindPlan'}
                    components={{
                        link1: <CustomLink href={`${config[partner].appUrl}/#/account/plans`} />,
                    }}
                />
            </Text>
            <Text className='mb-2'>
...
export default PLAN_RENEW_REMIND;
